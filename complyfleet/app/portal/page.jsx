        ...
        {loading ? <div style={{ textAlign: "center", padding: "60px", color: "#94A3B8" }}>Loading...</div> : (<>
          ...
          {tab === "overview" && (<>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "12px", marginBottom: "24px" }}>
              {[{ i: "\u{1F69B}", v: vehicles.length, l: "Vehicles", a: "#0F172A" }, { i: "\u{1F534}", v: overdue, l: "Overdue", a: "#DC2626" }, { i: "\u26A0\uFE0F", v: openDefects, l: "Open Defects", a: "#F59E0B" }, { i: "\u{1F4CB}", v: checks.length, l: "Checks (30d)", a: "#2563EB" }].map(s => (
                <div key={s.l} style={{ background: "#FFF", borderRadius: "16px", padding: "20px 24px", border: "1px solid #E5E7EB", display: "flex", alignItems: "center", gap: "16px" }}>
